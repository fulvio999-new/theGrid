(function ($) {
    ...
    $.fn.grid = function (data, columns, options, name) {
        ...
        plugin.bindEvents = function () {
            ...
            //----- patch fulvio: use single click
            //plugin.$el.on("dblclick.grid", ".sensei-grid-tbody>tr>td", plugin.dblClickCell); OLD
            plugin.$el.on("click.grid", ".sensei-grid-tbody>tr>td", plugin.dblClickCell);  //NEW
            //------
        ...
        plugin.getEditorInstance = function () {
            ...
            if (editorName && _.has(plugin.editors, editorName)) {
                ...
                //true for last row (the empty one)
